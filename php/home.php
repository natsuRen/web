 ...
 <div class="ctn">
    	<div class="head">
    		<div class="navigation">
    			<a class="register" href="logout.php?logout">Sign Out</a>
    			<a class="about-us" href="../html/example.html">choose template</a>
    	...
    	<div class="body2">
    		<div class="body2-img1"><a href="../html/example.html"><img class="pictures" src="../img/picture1.png"></a></div>
